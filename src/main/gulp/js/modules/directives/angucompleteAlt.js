...
App.directive('angucompleteAlt', ['$log','$q', '$parse', '$http', '$sce', '$timeout', '$templateCache', function ($log,$q, $parse, $http, $sce, $timeout, $templateCache) {
// keyboard events
    var KEY_DW  = 40;
    var KEY_RT  = 39;
    var KEY_UP  = 38;
    ...
    var TEXT_SEARCHING = '검색중...';
    var TEXT_NORESULTS = '검색 결과가 없습니다.<br /> email 계정이 있어야 광고캠페인 등록을 할 수 있습니다. <br /> [회원 관리]에서 회원 계정을 추가하십시오.';
